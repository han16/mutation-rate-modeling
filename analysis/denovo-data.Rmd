...
* GLM (use R function GLM)
  ...
  (1) The response is the ** total number of mutations ** in the category and the each feature is averaged across all widnows within the category (denoted as M2 (method 2))
...
barplot(DHS, beside=T, col=c("red", "darkblue"), legend=c("M1", "M2"), ylim=c(min(DHS), max(DHS)), main="DHS by different methods")
...
barplot(CpG, beside=T, col=c("red", "darkblue"), legend=c("M1", "M2"), ylim=c(min(CpG), max(CpG)), main="CpG island by different methods")
