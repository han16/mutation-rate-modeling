...
```{r, echo=F}
chr20_AtoC=loadRData("D:\\ResearchWork\\StatisticalGenetics\\Mutation-Rate-project\\parameter_estimate\\para.est.chr20.AtoC.RData")
...
* optim with categorization and without in many cases give similar estimates, while estimate by GLM is different 
