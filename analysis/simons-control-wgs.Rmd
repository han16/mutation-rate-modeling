...
#### M0 vs M2 by pooling all mutation types 


* each dot is one 100kb window 
...
x.limit=y.limit
ggplot(m0.m2.exp.obs.total, aes(x=obs, y=exp, color=model)) +
  geom_point()+
...
x.limit=y.limit
ggplot(m0.m2.exp.obs.total.nooutlier, aes(x=obs, y=exp, color=model)) +
  geom_point()+
  # xlim(c(0, x.limit))+ylim(c(0, y.limit))+
   geom_abline(intercept = 0, slope = 1)+
...
Note: In a few windows, the calculated expected rate could be unexpected high due to big recombination rate in several windows, such as 108.8. Below are such examples, the columns are chr, start, end, observed, ERVbaseline, DHS, CpGisland, lamin, gc, reptime, RecombRate, Exon, H3K27ac, H3K27me3, H3K36me3, H3K4me1, H3K4me3, H3K9ac, H3K9me3



chr8     139256300       139256400       0       4.227595e-08    0       0       1       0.26    .       108.804        0       0       0       0       0       1       0       1

chr8     139256400       139256500       0       7.081221e-08    0       0       1       0.39    .       108.804        0       0       0       0       0       1       0       1

chr8     139256500       139256600       0       1.1543496e-07   0       0       1       0.49    .       108.804        0       0       0       0       0       1       0       1

chr8     139256600       139256700       0       7.858366e-08    0       0       1       0.46    .       108.804        0       0       0       0       0       1       0       1

chr8     139256700       139256800       0       9.983582e-08    0       0       1       0.55    .       108.804        0       0       0       0       0       1       0       1

chr8     139256800       139256900       0       5.093645e-08    0       0       1       0.31    .       108.80
...
figures[[fig]]=
   ...
   ggplot(m0.m2.exp.obs.tidy, aes(x=obs, y=exp, color=model)) +
  geom_point()+
#   xlim(c(0, 10))+
#+ylim(c(0, y.limit))+
   geom_abline(intercept = 0, slope = 1)+
