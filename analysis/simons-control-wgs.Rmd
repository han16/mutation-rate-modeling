...
* M2(variable selection appears to be the worst one) 

* the higher predicted probability, the better, M1>M1(CpG)+M1(nonCpG)>M0>M2>M2(variable selection). 

* The way that calculates the precited probability for 3 CpG combined sample and 6 nonCpG combined sample is the same as in M1 by treating the subset of 3 CpG combined sample as the whole sample. 
...
total.post.pred=tibble(model=c("M0", "M1", "M1(CpG+nonCpG)", "M2", "M2(variable selection)"), post.pred=c(pp0, pp1, (pp1.CpG+pp1.nonCpG), pp2, pp2.variable.selection))
