...
barcenters=barplot(count, col=c("red", "blue", "green", "yellow"), beside=T, legend=c(0,1,2, ">2"), ylim=c(0,6), xlab="Standardized residual cutoff", ylab="Freq", main=mut.type[i],  args.legend=list(title="No.consecutive windows"))
