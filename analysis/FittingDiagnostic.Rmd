...
* to build distance matrix, any neighbor windows has one unit distance.  
* zero p values by Moran test  are set to $10^{-20}$ and thus points reaching 20 are with zero p values. 
